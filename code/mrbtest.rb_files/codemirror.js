...
}J.fromTextArea=function(f4,f6){if(!f6){f6={}
}f6.value=f4.value;
if(!f6.tabindex&&f4.tabindex){f6.tabindex=f4.tabindex
}if(!f6.placeholder&&f4.placeholder){f6.placeholder=f4.placeholder
}if(f6.autofocus==null){var f9=dE();
f6.autofocus=f9==f4||f4.getAttribute("autofocus")!=null&&f9==document.body
}function f7(){f4.value=f3.getValue()
}if(f4.form){bV(f4.form,"submit",f7);
if(!f6.leaveSubmitMethodAlone){var f5=f4.form.submit;
try{var ga=f4.form.submit=function(){f7();
f4.form.submit=f5;
f4.form.submit();
f4.form.submit=ga
}
}catch(f8){}}}f4.style.display="none";
var f3=J(function(gb){f4.parentNode.insertBefore(gb,f4.nextSibling)
},f6);
f3.save=f7;
f3.getTextArea=function(){return f4
};
f3.toTextArea=function(){f3.toTextArea=isNaN;
f7();
f4.parentNode.removeChild(f3.getWrapperElement());
f4.style.display="";
if(f4.form){d3(f4.form,"submit",f7);
if(typeof f4.form.submit=="function"){f4.form.submit=f5
}}};
f3.cleanup=function(){if(f4.form){d3(f4.form,"submit",f7)
}f3.toTextArea();
f4=null;
f3=null;
J.cleanup.apply(this)
};
return f3
};
...
J.cleanup=function(){var f6=this.display;
var f3=this.display.view;
for(var f5=0,f4=f3.length;
f5<f4;
f5++){f3[f5].lineNumber=null;
f3[f5].gutter=null;
f3[f5].line.parent=null;
f3[f5].line=null;
f3[f5].measure=null;
f3[f5].node=null;
f3[f5].text=null;
...
f6.scrollbarH=null;
f6.scrollbarV=null;
f6.scrollbarFiller=null;
f6.gutterFiller=null;
f6.lineDiv=null;
f6.selectionDiv=null;
f6.cursorDiv=null;
f6.measure=null;
f6.lineMeasure=null;
f6.lineSpace=null;
