require 'moodle_rb'
require_relative 'last_5_logins_report_html'
require 'pry'

OUTPUT_PATH = ENV['HOME'] + "/code/last_5_logins"
...
def grades_report
  class_data = @moodle.grades.by_course(4, [11,10,9,8,7])[0]
  # binding.pry
  begin
    Last5LoginsReportHTML.write(class_data["grades"], OUTPUT_PATH + ".html")
  rescue
