require 'moodle_rb'
require_relative 'grades_below_70_report_html'
require 'pry'

OUTPUT_PATH = ENV['HOME'] + "/code/grades_below_70"
...
def grades_report
  class_data = @moodle.grades.by_course(4, [6,7,8,10])[0]
  # binding.pry
  begin
    GradesBelow70ReportHTML.write(class_data["grades"], OUTPUT_PATH + ".html")
  rescue
